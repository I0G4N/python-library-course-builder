...
SKILL_DESCRIPTION = (
    "Use when a user asks to build, create, author, update, upgrade, or learn "
    "through a "
    ...
    "updating an explicitly located course generated by an earlier Skill version "
    "in place instead of regenerating it."
)
SKILL_SHORT_DESCRIPTION = "Build or update Python courses in Chinese or English"
SKILL_DEFAULT_PROMPT = (
    "Use $building-python-library-courses to create or update a source-backed "
